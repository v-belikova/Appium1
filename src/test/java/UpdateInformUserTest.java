...
public class UpdateInformUserTest extends Methods  {
    ...
    public void infoUpdateUserPositiveTest() throws InterruptedException {
        ...
        updateUserPage.nameUpdateInput.setValue("Long");
        updateUserPage.saveButton.click();
        updateUserPage.backButton.click();


        /*softAssert.assertTrue(updateUserPage.emailUpdateInput.isDisplayed(), "User name: Long");
        softAssert.assertTrue(updateUserPage.nameUpdateInput.isDisplayed(), "User email: Long@mail.ru");*/
